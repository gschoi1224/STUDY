...
const serverRender = async (req, res, next) => {
    ...
    ReactDOMServer.renderToStaticMarkup(jsx); // renderToStaticMarkUp으로 한번 더 렌더링함 이 함수로 만들면 인터랙션 지원 안함
    ...
    // JSON을 문자여롤 변환하고 악성 스크립트가 실행되는 것을 방지하기 위해 <를 치환 처리
    // https://redux.js.org/recipes/server-rendering#secureity-considerations
    ...
    res.send(createPath(root, tags)); // 클라이언트에게 결과물을 응답
};
